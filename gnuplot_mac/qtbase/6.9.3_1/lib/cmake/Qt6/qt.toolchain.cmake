...
if(NOT QT_QMAKE_TARGET_MKSPEC)
    set(QT_QMAKE_TARGET_MKSPEC macx-clang CACHE STRING "")
endif()

set(__qt_initial_c_compiler "clang")
set(__qt_initial_cxx_compiler "clang++")
...
if(NOT DEFINED CMAKE_OSX_SYSROOT)
    set(CMAKE_OSX_SYSROOT "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.sdk" CACHE STRING "")
endif()
set(CMAKE_OSX_DEPLOYMENT_TARGET "14.0" CACHE STRING "")
set(QT_OSX_ARCHITECTURES "" CACHE STRING "List of architectures Qt was built with")

# Only build multiple architectures when building Qt itself. Can be explicitly enabled or disabled.
if((QT_REPO_MODULE_VERSION AND NOT QT_FORCE_SINGLE_QT_OSX_ARCHITECTURE) OR QT_FORCE_ALL_QT_OSX_ARCHITECTURES)
    set(__qt_toolchain_building_qt_repo TRUE)
    set(CMAKE_OSX_ARCHITECTURES "${QT_OSX_ARCHITECTURES}" CACHE STRING "")
endif()
