...
set(__qt_QmlAssetDownloader_always_load_private_module ON)
set(__qt_QmlAssetDownloader_save_QT_NO_PRIVATE_MODULE_WARNING ${QT_NO_PRIVATE_MODULE_WARNING})
set(QT_NO_PRIVATE_MODULE_WARNING ON)
include("${CMAKE_CURRENT_LIST_DIR}/Qt6QmlAssetDownloader-build.cmake" OPTIONAL)
if (Qt6QmlAssetDownloader_FOUND
        AND NOT Qt6QmlAssetDownloaderPrivate_FOUND
        AND NOT FALSE
        AND (
            __qt_QmlAssetDownloader_always_load_private_module
    ...
    find_package(Qt6QmlAssetDownloaderPrivate "6.9.3" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt6QmlAssetDownloaderPrivate_FOUND)
        get_property(Qt6QmlAssetDownloaderPrivate_warning_shown GLOBAL PROPERTY
            Qt6QmlAssetDownloaderPrivate_warning_shown
        )
        if(NOT Qt6QmlAssetDownloaderPrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt6QmlAssetDownloaderPrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt6QmlAssetDownloaderPrivate_warning_shown ON
            )
        endif()
    endif()
endif()
set(QT_NO_PRIVATE_MODULE_WARNING ${__qt_QmlAssetDownloader_save_QT_NO_PRIVATE_MODULE_WARNING})
unset(__qt_QmlAssetDownloader_save_QT_NO_PRIVATE_MODULE_WARNING)
unset(__qt_QmlAssetDownloader_always_load_private_module)
