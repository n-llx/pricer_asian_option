...
set(__qt_QuickControls2Impl_always_load_private_module ON)
set(__qt_QuickControls2Impl_save_QT_NO_PRIVATE_MODULE_WARNING ${QT_NO_PRIVATE_MODULE_WARNING})
set(QT_NO_PRIVATE_MODULE_WARNING ON)
include("${CMAKE_CURRENT_LIST_DIR}/Qt6QuickControls2Impl-build.cmake" OPTIONAL)
if (Qt6QuickControls2Impl_FOUND
        AND NOT Qt6QuickControls2ImplPrivate_FOUND
        AND NOT FALSE
        AND (
            __qt_QuickControls2Impl_always_load_private_module
    ...
    find_package(Qt6QuickControls2ImplPrivate "6.9.3" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt6QuickControls2ImplPrivate_FOUND)
        get_property(Qt6QuickControls2ImplPrivate_warning_shown GLOBAL PROPERTY
            Qt6QuickControls2ImplPrivate_warning_shown
        )
        if(NOT Qt6QuickControls2ImplPrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt6QuickControls2ImplPrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt6QuickControls2ImplPrivate_warning_shown ON
            )
        endif()
    endif()
endif()
set(QT_NO_PRIVATE_MODULE_WARNING ${__qt_QuickControls2Impl_save_QT_NO_PRIVATE_MODULE_WARNING})
unset(__qt_QuickControls2Impl_save_QT_NO_PRIVATE_MODULE_WARNING)
unset(__qt_QuickControls2Impl_always_load_private_module)
...
if (NOT QT_NO_CREATE_TARGETS AND Qt6QuickControls2Impl_FOUND)
    ...
    if(NOT Qt6QuickControls2Impl_DEFINITIONS)
        ...
        set(updated_defs "")
        foreach(def IN LISTS  Qt6QuickControls2Impl_DEFINITIONS)
        ...
        endforeach()
        set(Qt6QuickControls2Impl_DEFINITIONS "${updated_defs}")
        unset(updated_defs)
    endif()
...
if (TARGET Qt6::QuickControls2Impl)
    ...
    if(NOT "QuickControls2Impl" IN_LIST QT_ALL_MODULES_FOUND_VIA_FIND_PACKAGE)
    ...
    if(NOT QT_NO_CREATE_VERSIONLESS_TARGETS)
        if(CMAKE_VERSION VERSION_LESS 3.18 OR QT_USE_OLD_VERSION_LESS_TARGETS)
            ...
            include("${CMAKE_CURRENT_LIST_DIR}/Qt6QuickControls2ImplVersionlessAliasTargets.cmake")
        endif()
    endif()
else()
