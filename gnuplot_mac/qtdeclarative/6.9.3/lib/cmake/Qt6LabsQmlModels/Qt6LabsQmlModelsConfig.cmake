...
set(__qt_LabsQmlModels_always_load_private_module ON)
set(__qt_LabsQmlModels_save_QT_NO_PRIVATE_MODULE_WARNING ${QT_NO_PRIVATE_MODULE_WARNING})
set(QT_NO_PRIVATE_MODULE_WARNING ON)
include("${CMAKE_CURRENT_LIST_DIR}/Qt6LabsQmlModels-build.cmake" OPTIONAL)
if (Qt6LabsQmlModels_FOUND
        AND NOT Qt6LabsQmlModelsPrivate_FOUND
        AND NOT FALSE
        AND (
            __qt_LabsQmlModels_always_load_private_module
    ...
    find_package(Qt6LabsQmlModelsPrivate "6.9.3" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt6LabsQmlModelsPrivate_FOUND)
        get_property(Qt6LabsQmlModelsPrivate_warning_shown GLOBAL PROPERTY
            Qt6LabsQmlModelsPrivate_warning_shown
        )
        if(NOT Qt6LabsQmlModelsPrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt6LabsQmlModelsPrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt6LabsQmlModelsPrivate_warning_shown ON
            )
        endif()
    endif()
endif()
set(QT_NO_PRIVATE_MODULE_WARNING ${__qt_LabsQmlModels_save_QT_NO_PRIVATE_MODULE_WARNING})
unset(__qt_LabsQmlModels_save_QT_NO_PRIVATE_MODULE_WARNING)
unset(__qt_LabsQmlModels_always_load_private_module)
...
if (TARGET Qt6::LabsQmlModels)
    ...
    if(NOT "LabsQmlModels" IN_LIST QT_ALL_MODULES_FOUND_VIA_FIND_PACKAGE)
