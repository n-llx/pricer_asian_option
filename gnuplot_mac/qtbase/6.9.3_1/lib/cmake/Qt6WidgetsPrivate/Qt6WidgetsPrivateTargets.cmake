...
foreach(_cmake_expected_target IN ITEMS Qt6::WidgetsPrivate)
...
set_target_properties(Qt6::WidgetsPrivate PROPERTIES
  ...
  _qt_package_name "Qt6WidgetsPrivate"
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/Qt6WidgetsPrivateTargets-*.cmake")
...
foreach(_target "Qt6::Widgets" "Qt6::CorePrivate" "Qt6::GuiPrivate" )
