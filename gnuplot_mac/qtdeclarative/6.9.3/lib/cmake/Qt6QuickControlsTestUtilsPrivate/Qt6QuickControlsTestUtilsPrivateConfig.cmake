...
if(EXISTS "${CMAKE_CURRENT_LIST_DIR}/Qt6QuickControlsTestUtilsPrivateDependencies.cmake")
    ...
    _qt_internal_suggest_dependency_debugging(QuickControlsTestUtilsPrivate
        __qt_QuickControlsTestUtilsPrivate_pkg ${CMAKE_FIND_PACKAGE_NAME}_NOT_FOUND_MESSAGE)
endif()
...
if (NOT QT_NO_CREATE_TARGETS AND Qt6QuickControlsTestUtilsPrivate_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6QuickControlsTestUtilsPrivateAdditionalTargetInfo.cmake"
        OPTIONAL)
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6QuickControlsTestUtilsPrivateExtraProperties.cmake"
        OPTIONAL)
endif()
...
set(__qt_QuickControlsTestUtilsPrivate_always_load_private_module ON)
set(__qt_QuickControlsTestUtilsPrivate_save_QT_NO_PRIVATE_MODULE_WARNING ${QT_NO_PRIVATE_MODULE_WARNING})
set(QT_NO_PRIVATE_MODULE_WARNING ON)
include("${CMAKE_CURRENT_LIST_DIR}/Qt6QuickControlsTestUtilsPrivate-build.cmake" OPTIONAL)
if (Qt6QuickControlsTestUtilsPrivate_FOUND
        AND NOT Qt6QuickControlsTestUtilsPrivatePrivate_FOUND
        AND NOT TRUE
        AND (
            __qt_QuickControlsTestUtilsPrivate_always_load_private_module
    ...
    find_package(Qt6QuickControlsTestUtilsPrivatePrivate "6.9.3" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt6QuickControlsTestUtilsPrivatePrivate_FOUND)
        get_property(Qt6QuickControlsTestUtilsPrivatePrivate_warning_shown GLOBAL PROPERTY
            Qt6QuickControlsTestUtilsPrivatePrivate_warning_shown
        )
        if(NOT Qt6QuickControlsTestUtilsPrivatePrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt6QuickControlsTestUtilsPrivatePrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt6QuickControlsTestUtilsPrivatePrivate_warning_shown ON
            )
        endif()
    endif()
endif()
set(QT_NO_PRIVATE_MODULE_WARNING ${__qt_QuickControlsTestUtilsPrivate_save_QT_NO_PRIVATE_MODULE_WARNING})
unset(__qt_QuickControlsTestUtilsPrivate_save_QT_NO_PRIVATE_MODULE_WARNING)
unset(__qt_QuickControlsTestUtilsPrivate_always_load_private_module)
...
if (NOT QT_NO_CREATE_TARGETS AND Qt6QuickControlsTestUtilsPrivate_FOUND)
    ...
    if(NOT Qt6QuickControlsTestUtilsPrivate_DEFINITIONS)
        ...
        set(updated_defs "")
        foreach(def IN LISTS  Qt6QuickControlsTestUtilsPrivate_DEFINITIONS)
        ...
        endforeach()
        set(Qt6QuickControlsTestUtilsPrivate_DEFINITIONS "${updated_defs}")
        unset(updated_defs)
    endif()
    ...
    foreach(_module_dep ${_Qt6QuickControlsTestUtilsPrivate_MODULE_DEPENDENCIES})
        ...
        list(APPEND Qt6QuickControlsTestUtilsPrivate${_private_suffix}_INCLUDE_DIRS
             ${Qt6${_module_dep}_INCLUDE_DIRS})
        list(APPEND Qt6QuickControlsTestUtilsPrivate${_private_suffix}_PRIVATE_INCLUDE_DIRS
             ${Qt6${_module_dep}_PRIVATE_INCLUDE_DIRS})
        if(_private_suffix)
            list(APPEND Qt6QuickControlsTestUtilsPrivate_PRIVATE_INCLUDE_DIRS
                ${Qt6${_module_dep}_PRIVATE_INCLUDE_DIRS})
        endif()
        list(APPEND Qt6QuickControlsTestUtilsPrivate${_private_suffix}_DEFINITIONS
             ${Qt6${_module_dep}_DEFINITIONS})
        list(APPEND Qt6QuickControlsTestUtilsPrivate${_private_suffix}_COMPILE_DEFINITIONS
...
if (TARGET Qt6::QuickControlsTestUtilsPrivate)
    ...
    if(NOT "QuickControlsTestUtilsPrivate" IN_LIST QT_ALL_MODULES_FOUND_VIA_FIND_PACKAGE)
        ...
        list(APPEND QT_ALL_MODULES_VERSIONED_FOUND_VIA_FIND_PACKAGE
            "Qt6::QuickControlsTestUtilsPrivate")
    endif()
    ...
    if(NOT QT_NO_CREATE_VERSIONLESS_TARGETS)
        if(CMAKE_VERSION VERSION_LESS 3.18 OR QT_USE_OLD_VERSION_LESS_TARGETS)
            ...
            include("${CMAKE_CURRENT_LIST_DIR}/Qt6QuickControlsTestUtilsPrivateVersionlessAliasTargets.cmake")
        endif()
    endif()
else()
    ...
    if(NOT DEFINED Qt6QuickControlsTestUtilsPrivate_NOT_FOUND_MESSAGE)
        set(Qt6QuickControlsTestUtilsPrivate_NOT_FOUND_MESSAGE
            "Target \"Qt6::QuickControlsTestUtilsPrivate\" was not found.")
