...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': '/c/Prog/winlibs_staging_ucrt/mingw64/bin/x86_64-w64-mingw32-gcc.exe '
 ...
 'BYTESTR_DEPS': '\\',
 'CC': '/c/Prog/winlibs_staging_ucrt/mingw64/bin/x86_64-w64-mingw32-gcc.exe '
       '-fno-ident',
 'CCSHARED': '',
 ...
 'CONFIGURE_CFLAGS_NODIST': '-std=c99 -Wextra -Wno-unused-result '
                            ...
                            '-DMS_DLL_ID=\'"3.9"\'',
 'CONFIGURE_CPPFLAGS': '-I../PC  -I.',
 'CONFIGURE_LDFLAGS': '',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIG_ARGS': "'--prefix=' + os.path.abspath(os.path.dirname(os.path.abspath(__file__))) + '/share/python' "
 ...
 'DESTDIRS': '' + os.path.abspath(os.path.dirname(os.path.abspath(__file__))) + '/share/python '
             '' + os.path.abspath(os.path.dirname(os.path.abspath(__file__))) + '/share/python/lib '
             '' + os.path.abspath(os.path.dirname(os.path.abspath(__file__))) + '/share/python/lib/python3.9 '
             '' + os.path.abspath(os.path.dirname(os.path.abspath(__file__))) + '/share/python/lib/python3.9/lib-dynload',
 'DESTLIB': '' + os.path.abspath(os.path.dirname(os.path.abspath(__file__))) + '/share/python/lib/python3.9',
 'DESTPATH': '',
 'DESTSHARED': '' + os.path.abspath(os.path.dirname(os.path.abspath(__file__))) + '/share/python/lib/python3.9/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '' + os.path.abspath(os.path.dirname(os.path.abspath(__file__))) + '/share/python/include '
                   '' + os.path.abspath(os.path.dirname(os.path.abspath(__file__))) + '/share/python/include '
                   '' + os.path.abspath(os.path.dirname(os.path.abspath(__file__))) + '/share/python/include/python3.9 '
                   '' + os.path.abspath(os.path.dirname(os.path.abspath(__file__))) + '/share/python/include/python3.9',
 'INCLUDEDIR': '' + os.path.abspath(os.path.dirname(os.path.abspath(__file__))) + '/share/python/include',
 'INCLUDEPY': '' + os.path.abspath(os.path.dirname(os.path.abspath(__file__))) + '/share/python/include/python3.9',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': '/c/Prog/winlibs_staging_ucrt/mingw64/bin/x86_64-w64-mingw32-g++.exe '
                '-fno-ident -shared -Wl,--enable-auto-image-base',
 'LDFLAGS': '',
 'LDLIBRARY': 'libpython3.9.dll.a',
 'LDLIBRARYDIR': '',
 'LDSHARED': '/c/Prog/winlibs_staging_ucrt/mingw64/bin/x86_64-w64-mingw32-gcc.exe '
             '-fno-ident -shared -Wl,--enable-auto-image-base',
 'LDVERSION': '3.9',
 'LIBC': '',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '' + os.path.abspath(os.path.dirname(os.path.abspath(__file__))) + '/share/python/lib/pkgconfig',
 'LIBPL': '' + os.path.abspath(os.path.dirname(os.path.abspath(__file__))) + '/share/python/lib/python3.9/config-3.9',
 ...
 'LINKCC': '/c/Prog/winlibs_staging_ucrt/mingw64/bin/x86_64-w64-mingw32-gcc.exe '
           '-fno-ident',
 ...
 'MAINCC': '/c/Prog/winlibs_staging_ucrt/mingw64/bin/x86_64-w64-mingw32-gcc.exe '
           '-fno-ident',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': '../Modules/makesetup',
 'MANDIR': '' + os.path.abspath(os.path.dirname(os.path.abspath(__file__))) + '/share/python/share/man',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g  -O3 -Wall '
                   ...
                   '-I../Include -I../PC  -I. -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '',
 'PY_CPPFLAGS': '-IObjects -IInclude -IPython -I. -I../Include -I../PC  -I.',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '',
 'PY_LDFLAGS_NODIST': '',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '' + os.path.abspath(os.path.dirname(os.path.abspath(__file__))) + '/share/python/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '@SGI_ABI@',
 'SHELL': '/bin/sh',
