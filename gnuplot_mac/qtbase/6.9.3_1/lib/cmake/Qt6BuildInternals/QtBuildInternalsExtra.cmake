...
if(CMAKE_INSTALL_PREFIX_INITIALIZED_TO_DEFAULT AND
    ...
    set(qtbi_orig_prefix "/opt/homebrew")
    set(qtbi_orig_staging_prefix "/opt/homebrew/Cellar/qtbase/6.9.3_1")
...
set(QT_SOURCE_TREE "/private/tmp/qtbase-20251107-10466-ohktt8/qtbase-everywhere-src-6.9.3" CACHE PATH
...
set(TEST_architecture_architectures "arm64" CACHE INTERNAL "")
set(TEST_subarch_result "cx16;neon;crc32;crypto" CACHE INTERNAL "")
set(TEST_arch_arm64_abi "arm64-little_endian-lp64" CACHE INTERNAL "")
set(TEST_arch_arm64_subarch_cx16 "1" CACHE INTERNAL "")
set(TEST_arch_arm64_subarch_neon "1" CACHE INTERNAL "")
set(TEST_arch_arm64_subarch_crc32 "1" CACHE INTERNAL "")
set(TEST_arch_arm64_subarch_crypto "1" CACHE INTERNAL "")
...
set(QT_IS_MACOS_UNIVERSAL "OFF" CACHE BOOL "")
set(QT_QPA_DEFAULT_PLATFORM "cocoa" CACHE STRING "")
set(QT_QPA_PLATFORMS "cocoa" CACHE STRING "")
...
set(INSTALL_MKSPECSDIR "share/qt/mkspecs" CACHE STRING "Mkspecs files [PREFIX/mkspecs]" FORCE)
set(INSTALL_ARCHDATADIR "share/qt" CACHE STRING "Arch-dependent data [PREFIX]" FORCE)
set(INSTALL_PLUGINSDIR "share/qt/plugins" CACHE STRING "Plugins [ARCHDATADIR/plugins]" FORCE)
set(INSTALL_LIBEXECDIR "share/qt/libexec" CACHE STRING "Helper programs [ARCHDATADIR/bin on Windows, ARCHDATADIR/libexec otherwise]" FORCE)
set(INSTALL_QMLDIR "share/qt/qml" CACHE STRING "QML imports [ARCHDATADIR/qml]" FORCE)
set(INSTALL_DATADIR "share/qt" CACHE STRING "Arch-independent data [PREFIX]" FORCE)
set(INSTALL_DOCDIR "share/qt/doc" CACHE STRING "Documentation [DATADIR/doc]" FORCE)
set(INSTALL_TRANSLATIONSDIR "share/qt/translations" CACHE STRING "Translations [DATADIR/translations]" FORCE)
...
set(INSTALL_EXAMPLESDIR "share/qt/examples" CACHE STRING "Examples [PREFIX/examples]" FORCE)
set(INSTALL_TESTSDIR "share/qt/tests" CACHE STRING "Tests [PREFIX/tests]" FORCE)
set(INSTALL_DESCRIPTIONSDIR "share/qt/modules" CACHE STRING "Module description files directory" FORCE)
set(INSTALL_SBOMDIR "share/qt/sbom" CACHE STRING "SBOM [PREFIX/sbom]" FORCE)
