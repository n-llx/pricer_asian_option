...
set(__qt_Gui_save_QT_NO_PRIVATE_MODULE_WARNING ${QT_NO_PRIVATE_MODULE_WARNING})
set(QT_NO_PRIVATE_MODULE_WARNING ON)
include("${CMAKE_CURRENT_LIST_DIR}/Qt6Gui-build.cmake" OPTIONAL)
if (Qt6Gui_FOUND
        AND NOT Qt6GuiPrivate_FOUND
        AND NOT FALSE
        AND (
            __qt_Gui_always_load_private_module
    ...
    find_package(Qt6GuiPrivate "6.9.3" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt6GuiPrivate_FOUND)
        get_property(Qt6GuiPrivate_warning_shown GLOBAL PROPERTY
            Qt6GuiPrivate_warning_shown
        )
        if(NOT Qt6GuiPrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt6GuiPrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt6GuiPrivate_warning_shown ON
            )
        endif()
    endif()
endif()
set(QT_NO_PRIVATE_MODULE_WARNING ${__qt_Gui_save_QT_NO_PRIVATE_MODULE_WARNING})
unset(__qt_Gui_save_QT_NO_PRIVATE_MODULE_WARNING)
