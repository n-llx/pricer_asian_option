...
set(__qt_Core_always_load_private_module ON)
set(__qt_Core_save_QT_NO_PRIVATE_MODULE_WARNING ${QT_NO_PRIVATE_MODULE_WARNING})
set(QT_NO_PRIVATE_MODULE_WARNING ON)
include("${CMAKE_CURRENT_LIST_DIR}/Qt6Core-build.cmake" OPTIONAL)
if (Qt6Core_FOUND
        AND NOT Qt6CorePrivate_FOUND
        AND NOT FALSE
        AND (
    ...
    find_package(Qt6CorePrivate "6.9.3" EXACT
        QUIET
        CONFIG
        PATHS
...
set(QT_NO_PRIVATE_MODULE_WARNING ${__qt_Core_save_QT_NO_PRIVATE_MODULE_WARNING})
unset(__qt_Core_save_QT_NO_PRIVATE_MODULE_WARNING)
unset(__qt_Core_always_load_private_module)
