...
if (NOT QT_NO_CREATE_TARGETS AND Qt6FbSupportPrivate_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6FbSupportPrivateAdditionalTargetInfo.cmake"
        OPTIONAL)
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6FbSupportPrivateExtraProperties.cmake"
        OPTIONAL)
endif()
...
set(__qt_FbSupportPrivate_always_load_private_module ON)
set(__qt_FbSupportPrivate_save_QT_NO_PRIVATE_MODULE_WARNING ${QT_NO_PRIVATE_MODULE_WARNING})
set(QT_NO_PRIVATE_MODULE_WARNING ON)
include("${CMAKE_CURRENT_LIST_DIR}/Qt6FbSupportPrivate-build.cmake" OPTIONAL)
if (Qt6FbSupportPrivate_FOUND
        AND NOT Qt6FbSupportPrivatePrivate_FOUND
        AND NOT TRUE
        AND (
            __qt_FbSupportPrivate_always_load_private_module
    ...
    find_package(Qt6FbSupportPrivatePrivate "6.9.3" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt6FbSupportPrivatePrivate_FOUND)
        get_property(Qt6FbSupportPrivatePrivate_warning_shown GLOBAL PROPERTY
            Qt6FbSupportPrivatePrivate_warning_shown
        )
        if(NOT Qt6FbSupportPrivatePrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt6FbSupportPrivatePrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt6FbSupportPrivatePrivate_warning_shown ON
            )
        endif()
    endif()
endif()
set(QT_NO_PRIVATE_MODULE_WARNING ${__qt_FbSupportPrivate_save_QT_NO_PRIVATE_MODULE_WARNING})
unset(__qt_FbSupportPrivate_save_QT_NO_PRIVATE_MODULE_WARNING)
unset(__qt_FbSupportPrivate_always_load_private_module)
...
if (NOT QT_NO_CREATE_TARGETS AND Qt6FbSupportPrivate_FOUND)
    ...
    if(NOT Qt6FbSupportPrivate_DEFINITIONS)
        ...
        set(updated_defs "")
        foreach(def IN LISTS  Qt6FbSupportPrivate_DEFINITIONS)
        ...
        endforeach()
        set(Qt6FbSupportPrivate_DEFINITIONS "${updated_defs}")
        unset(updated_defs)
    endif()
    ...
    foreach(_module_dep ${_Qt6FbSupportPrivate_MODULE_DEPENDENCIES})
        ...
        list(APPEND Qt6FbSupportPrivate${_private_suffix}_INCLUDE_DIRS
             ${Qt6${_module_dep}_INCLUDE_DIRS})
        list(APPEND Qt6FbSupportPrivate${_private_suffix}_PRIVATE_INCLUDE_DIRS
             ${Qt6${_module_dep}_PRIVATE_INCLUDE_DIRS})
        if(_private_suffix)
            list(APPEND Qt6FbSupportPrivate_PRIVATE_INCLUDE_DIRS
                ${Qt6${_module_dep}_PRIVATE_INCLUDE_DIRS})
        endif()
        list(APPEND Qt6FbSupportPrivate${_private_suffix}_DEFINITIONS
             ${Qt6${_module_dep}_DEFINITIONS})
        list(APPEND Qt6FbSupportPrivate${_private_suffix}_COMPILE_DEFINITIONS
...
if (TARGET Qt6::FbSupportPrivate)
    ...
    if(NOT "FbSupportPrivate" IN_LIST QT_ALL_MODULES_FOUND_VIA_FIND_PACKAGE)
    ...
    if(NOT QT_NO_CREATE_VERSIONLESS_TARGETS)
        if(CMAKE_VERSION VERSION_LESS 3.18 OR QT_USE_OLD_VERSION_LESS_TARGETS)
            ...
            include("${CMAKE_CURRENT_LIST_DIR}/Qt6FbSupportPrivateVersionlessAliasTargets.cmake")
        endif()
    endif()
else()
