...
set(__qt_Xml_always_load_private_module ON)
set(__qt_Xml_save_QT_NO_PRIVATE_MODULE_WARNING ${QT_NO_PRIVATE_MODULE_WARNING})
set(QT_NO_PRIVATE_MODULE_WARNING ON)
include("${CMAKE_CURRENT_LIST_DIR}/Qt6Xml-build.cmake" OPTIONAL)
if (Qt6Xml_FOUND
        AND NOT Qt6XmlPrivate_FOUND
        AND NOT FALSE
        AND (
            __qt_Xml_always_load_private_module
    ...
    find_package(Qt6XmlPrivate "6.9.3" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt6XmlPrivate_FOUND)
        get_property(Qt6XmlPrivate_warning_shown GLOBAL PROPERTY
            Qt6XmlPrivate_warning_shown
        )
        if(NOT Qt6XmlPrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt6XmlPrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt6XmlPrivate_warning_shown ON
            )
        endif()
    endif()
endif()
set(QT_NO_PRIVATE_MODULE_WARNING ${__qt_Xml_save_QT_NO_PRIVATE_MODULE_WARNING})
unset(__qt_Xml_save_QT_NO_PRIVATE_MODULE_WARNING)
unset(__qt_Xml_always_load_private_module)
